...
const PhoneSetup = ({ phoneNumber: initialPhone, isPhoneSet: initialIsPhoneSet }) => {
  const [phoneNumber, setPhoneNumber] = useState(initialPhone || '');
  const [isPhoneSet, setIsPhoneSet] = useState(initialIsPhoneSet || false);
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      {!isPhoneSet ? (
        ...
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-gray-900 mb-1">Phone Number Set</p>
